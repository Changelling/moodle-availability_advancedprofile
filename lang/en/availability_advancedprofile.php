...
$string['conditiontitle'] = 'User advanced profile field';
$string['description'] = 'Control access based on fields within the student\'s advanced profile.';
$string['error_selectfield'] = 'You must select a advanced profile field.';
...
$string['pluginname'] = 'Restriction by advanced profile';
...
$string['requires_isbigger'] = 'Your <strong>{$a->field}</strong> is bigger than <strong>{$a->value}</strong>';
$string['requires_issmaller'] = 'Your <strong>{$a->field}</strong> is smaller than <strong>{$a->value}</strong>';
$string['missing'] = '(Missing custom field: {$a})';
$string['title'] = 'User advanced profile';
...
$string['op_isbigger'] = 'is bigger than';
$string['op_issmaller'] = 'is smaller than';
$string['privacy:metadata'] = 'The Restriction by advanced profile plugin does not store any personal data.';