@availability @availability_advancedprofile
Feature: availability_advancedprofile
  In order to control student access to activities
  As a teacher
  I need to set advancedprofile conditions which prevent student access
  ...
  Scenario: Test condition
    ...
    And I click on "User advancedprofile" "button"
    And I set the field "User advancedprofile field" to "Email address"
  ...
  @javascript
  Scenario: Test with custom user advancedprofile field
    # Add custom field.
    Given I log in as "admin"
    And I navigate to "Users > Accounts > User advancedprofile fields" in site administration
    ...
    And I click on "Update advancedprofile" "button"
    ...
    And I click on "User advancedprofile" "button"
    And I set the following fields to these values:
      | User advancedprofile field       | Super field |
    ...
    And I expand all fieldsets
    Then the field "User advancedprofile field" matches value "Super field"
