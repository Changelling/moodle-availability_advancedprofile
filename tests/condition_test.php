...
/**
 * Unit tests for the user advancedprofile condition.
 *
...
use availability_advancedprofile\condition;
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class availability_advancedprofile_condition_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        // Clear static cache.
        \availability_advancedprofile\condition::wipe_static_cache();
    ...
    public function test_custom_textarea_field() {
        ...
        $fields = condition::get_custom_advancedprofile_fields();
